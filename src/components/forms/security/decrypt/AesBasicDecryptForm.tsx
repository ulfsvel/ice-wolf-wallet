...
import Wallet, {AesBasicTransferForm} from "../../../../types/Wallet";
...
const AesBasicDecryptForm = ({wallet, dispatch}: AesBasicDecryptFormProps) => {
...
export default connect(mapStateToProps)(AesBasicDecryptForm);