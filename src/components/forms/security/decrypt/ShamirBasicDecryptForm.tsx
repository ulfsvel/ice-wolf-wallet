...
import Wallet, {ShamirBasicTransferForm} from "../../../../types/Wallet";
...
const ShamirBasicDecryptForm = ({wallet, dispatch}: ShamirBasicDecryptFormProps) => {
    const classes = useStyles();
    const form = wallet.state.sendFoundsForm as unknown as ShamirBasicTransferForm;

    const updateWalletDecryptForm = (key: "password" | 'to' | 'amount') => (event: React.ChangeEvent<HTMLInputElement>) => {
        dispatch(setWallet({
            ...wallet,
            state: {
                ...wallet.state,
...
export default connect(mapStateToProps)(ShamirBasicDecryptForm);